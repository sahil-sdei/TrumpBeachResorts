package sdei.trumpbeach.resort.utils.widgets;
...
/**
 * Created by G-Expo on 15 Nov 2016.
 */


/**
 * Custom View to show badge count anywhere in the app.
 */

public class BadgeViewG extends android.support.v7.widget.AppCompatTextView
{
    ...
    public BadgeViewG(final Context context)
    {
        this(context, null);
    }

    public BadgeViewG(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public BadgeViewG(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    private class OvalShadow extends OvalShape
    {
        ...
        {
            final int viewWidth  = BadgeViewG.this.getWidth();
            final int viewHeight = BadgeViewG.this.getHeight();
